...
download.file(fileUrl,destfile="./data/UCI_HAR_Dataset.zip",mode='wb') # mode should be set to "wb" as .zip is a binary format, if you use mac or work on linux system add method="curl" 
